                  ...
                  <div className="space-y-2 mb-4">
                    {profession.grades.map((grade) => (
                      <div key={grade.grade} className="flex justify-between items-center text-sm">
                        <Link
                          href={`/table/profession/${encodeURIComponent(profession.professionName)}-${grade.grade}`} className="underline underline-offset-2 text-muted-foreground">{grade.grade}级
                        </Link>
