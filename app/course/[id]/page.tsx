  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-primary/5 to-accent/5 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-6xl mx-auto p-4 lg:p-6 space-y-8">
          ...
          <div className="p-6 md:p-8">
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold text-foreground">{course.subject.name}</h1>
        ...
        <Card className="overflow-hidden">
          <div className="p-6">
            <h2 className="text-xl font-bold text-foreground mb-4">上课安排</h2>
...
export async function generateMetadata({ params }: { params: { id: string } }): Promise<Metadata> {
  ...
  try {
    ...
    if (course) {
      return {
        title: `${course.subject.name} - 课程详情`,
        description: `中南大学${course.subject.name}课程详情，包含课程基本信息、上课安排和选课学生列表`,
        keywords: [
          '中南大学',
          '课程详情',
          course.subject.name,
